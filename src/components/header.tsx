            ...
            <div className="px-4 sm:px-8 lg:px-20 py-3 sm:py-5">
                ...
                <div className="hidden lg:grid lg:grid-cols-3 lg:items-center">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        />
                        <p className="text-2xl xl:text-3xl text-white font-thin tracking-widest">OASES</p>
                    </div>
                ...
                <div className="lg:hidden">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            />
                            <p className="text-xl sm:text-2xl text-white font-thin tracking-widest">OASES</p>
                        </div>
