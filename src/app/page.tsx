    ...
    return (
        <main className="flex flex-col w-full m-0 p-0 bg-black items-center justify-items-center font-[family-name:var(--font-geist-sans)]">
                ...
                <div className="relative z-20 w-full h-full grid grid-cols-1 gap-y-10 md:grid-cols-3 grid-rows-3 max-w-7xl mx-auto px-4">
                    ...
                    <div className="flex justify-center items-center w-full h-full gap-x-5 row-start-2 col-start-1 md:col-start-2">
                        <div className="text-white gap-3">
                            <h1 className="text-4xl md:text-7xl font-thin">OASES</h1>
                            <h2 className="text-xl md:text-3xl font-light tracking-[7px] text-[#222] italic">Real Estate</h2>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center items-end pb-20 col-start-1 md:col-start-2 row-start-3">
                        <Link
                            href="#"
                            className="text-xl text-center border border-white text-white rounded-xl py-5 px-8 hover:bg-white hover:text-black transition-colors"
                        >
                            Get started
                        </Link>
                    </div>
            ...
            <section className="grid max-md:grid-cols-1 grid-cols-[45vw_1fr] w-full items-center m-0">
                <div className="flex flex-col items-center justify-center h-[50vh] px-5 md:px-20 gap-y-4 bg-gray-300">
                    ...
                    <span className="text-2xl text-[#222]">&middot;</span>
                </div>
                <div className="flex flex-col w-full border-t h-[50vh] border-dashed text-gray-400 justify-center items-center px-5 md:px-20 gap-y-4">
                    <p className="text-4xl md:text-6xl font-thin italic tracking-wide text-center text-gray-300">
                        &#34;Built by the people
                        <br /> for the people&#34;
                    </p>
                </div>
            ...
            <section className="grid max-md:grid-cols-1 grid-cols-[1fr_45vw] w-full items-center m-0">
                <div className="flex flex-col max-md:order-2 justify-center h-[50vh] border-t border-dashed w-full px-5 md:px-20 gap-y-4">
                    <p className="text-4xl md:text-6xl font-thin italic tracking-wide text-center text-gray-300">
                        Growing <span className="text-orange-500">Kasi</span> Property, <br />
                        One connection at a Time.
                    </p>
                </div>
                <div className="flex flex-col max-md:order-1 items-center justify-center px-5 md:px-20 h-[50vh] gap-y-4 bg-gray-300">
                    <p className="text-lg md:text-xl text-center font-light text-[#222] tracking-[2.5px]">
